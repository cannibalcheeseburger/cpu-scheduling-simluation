...
def compare():
    ...
    plt.bar(x,pp_waiting,width=0.1,label = "Priority Preemptive")   
    plt.bar(x+0.1,sn_waiting,width=0.1,label = "SJF Non Preemptive",) 
    plt.bar(x+0.2,sp_waiting,width=0.1,label = "SJF Preemptive")   
